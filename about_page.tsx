  ...
  return (
    <main style={{ background: '#07090c', minHeight: '100vh', padding: '72px 24px 96px' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <p style={prose}>
          Our live data systems — ISS tracking, deep-space telemetry, launch countdowns — pull from authoritative APIs including NASA JPL Horizons, Launch Library 2, and the NASA Open API. When APIs fail, we show the last verified data rather than blank pages or estimates.
        </p>
        ...
        <p style={prose}>
          The platform is designed from the ground up to be scalable: built on Next.js, Supabase, and Vercel, with a modular architecture that can grow from one person to a full editorial team without a rebuild.
        </p>
