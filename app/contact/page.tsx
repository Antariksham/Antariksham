      ...
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '48px' }}>
          ...
          <div style={contactCard}>
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#3b9eff' }}>
              General Enquiries
            </div>
            <p style={{ ...prose, margin: 0, fontSize: '15px' }}>
              Questions about the platform, feedback, or anything else.
            </p>
            <a href={`mailto:${siteConfig.email}`} style={{ fontFamily: 'DM Mono, monospace', fontSize: '14px', color: '#3b9eff', textDecoration: 'none', marginTop: '4px' }}>
              {siteConfig.email}
            </a>
          </div>

          <div style={contactCard}>
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(240,90,90,0.8)' }}>
            ...
            <a href={`mailto:${siteConfig.email}?subject=Correction`} style={{ fontFamily: 'DM Mono, monospace', fontSize: '14px', color: '#3b9eff', textDecoration: 'none', marginTop: '4px' }}>
              {siteConfig.email}
            </a>
          </div>

          <div style={contactCard}>
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(52,216,151,0.8)' }}>
            ...
            <a href={`mailto:${siteConfig.email}?subject=Story+Tip`} style={{ fontFamily: 'DM Mono, monospace', fontSize: '14px', color: '#3b9eff', textDecoration: 'none', marginTop: '4px' }}>
              {siteConfig.email}
            </a>
          </div>

          <div style={contactCard}>
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(201,169,110,0.8)' }}>
            ...
            <a href={`mailto:${siteConfig.email}?subject=Collaboration`} style={{ fontFamily: 'DM Mono, monospace', fontSize: '14px', color: '#3b9eff', textDecoration: 'none', marginTop: '4px' }}>
              {siteConfig.email}
            </a>
          </div>
        ...
        <p style={prose}>
          For urgent factual corrections on actively circulating articles, please mark your subject line <strong style={{ color: 'rgba(240,244,250,0.9)', fontWeight: 600 }}>URGENT CORRECTION</strong> and we will respond as soon as possible.
        </p>
