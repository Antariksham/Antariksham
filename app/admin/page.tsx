            ...
            {stats.recentArticles.map((article, i) => (
              ...
              >
                ...
                <Link
                  ...
                  style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent)', textDecoration: 'none', flexShrink: 0, padding: '4px 10px', border: '1px solid rgba(79,142,247,0.3)', borderRadius: '4px' }}
                >
                  Edit
                </Link>
              </div>
