  ...
  return (
    <div style={{ maxWidth: '900px' }}>
      ...
      <div style={{ marginBottom: '40px', paddingBottom: '28px', borderBottom: '1px solid var(--border)' }}>
        ...
        <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--faint)', letterSpacing: '0.06em', margin: 0 }}>
      ...
      <div>
        ...
        {stats.recentArticles.length === 0 ? (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px', padding: '40px', textAlign: 'center' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--faint)', letterSpacing: '0.15em', textTransform: 'uppercase', margin: '0 0 12px' }}>
              No articles yet
            </p>
            ...
            {stats.recentArticles.map((article, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--faint)', margin: '3px 0 0', letterSpacing: '0.05em' }}>
                ...
                {/* Views */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px', color: 'var(--faint)', flexShrink: 0 }}>
                  <Eye size={11} />
                ...
                <Link
                  ...
                  style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent)', textDecoration: 'none', flexShrink: 0, padding: '4px 10px', border: '1px solid var(--border)', borderRadius: '4px' }}
                >
                  Edit
                </Link>
              </div>
  ...
  return (
    <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px', padding: '18px 20px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '7px', marginBottom: '12px' }}>
        ...
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--faint)' }}>
          {label}
        </span>
      </div>
      <div style={{ fontFamily: 'var(--font-mono)', fontSize: '28px', color, fontWeight: 300, lineHeight: 1 }}>
        {value}
      </div>
    </div>
  )
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--faint)', margin: '0 0 12px' }}>
      {children}
    </p>
  )
}
