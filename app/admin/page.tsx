      ...
      <div>
        ...
        {stats.recentArticles.length === 0 ? (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px', padding: '40px', textAlign: 'center' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', color: 'rgba(var(--ink),0.65)', letterSpacing: '0.15em', textTransform: 'uppercase', margin: '0 0 12px' }}>
              No articles yet
            </p>
            ...
            {stats.recentArticles.map((article, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'rgba(var(--ink),0.55)', margin: '3px 0 0', letterSpacing: '0.05em' }}>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(var(--ink),0.6)', margin: '0 0 12px' }}>
      {children}
    </p>
  )
}
