// Hindi twin of app/editorial-policy/page.tsx.
//
...
export const metadata: Metadata = localizedMetadata({
  ...
  lang:        LANG,
  title:       t('page.editorialPolicy.title'),
  description: t('page.editorialPolicy.desc'),
})

export { default } from '@/app/editorial-policy/page'
