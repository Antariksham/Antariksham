// Hindi twin of app/live/iss-tracker/page.tsx.
//
...
export const metadata: Metadata = localizedMetadata({
  ...
  lang:        LANG,
  title:       t('page.issTracker.title'),
  description: t('page.issTracker.desc'),
})

export { default } from '@/app/live/iss-tracker/page'
