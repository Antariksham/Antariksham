    ...
    <a href={`/news/${article.slug}`} className="card">
      ...
      <div className="card-body">
        {article.articleType === 'breaking-news' && (
          <span style={{ alignSelf: 'flex-start', fontFamily: 'var(--font-sans)', fontSize: '0.62rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#ffffff', background: 'var(--red)', padding: '2px 8px', borderRadius: '3px', marginBottom: '0.5rem' }}>
            Breaking
          </span>
        )}
