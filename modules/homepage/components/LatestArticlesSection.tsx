...
import { sectionHref, articlesListHref, DEFAULT_LANGUAGE, type LanguageCode } from '@/lib/i18n'
    ...
    <section className="section">
      ...
      {items.length === 0 ? (
        ...
        <div className="grid-3">
          {items.map(a => (
            <Link key={a.id} href={sectionHref('articles', a.slug, lang)} className="card">
              {a.featuredImage
