    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '12px' }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p style={{ margin: '4px 0 0', fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(var(--ink),0.4)', letterSpacing: '0.08em' }}>
            {launch.rocket}
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <Clock size={11} style={{ color: 'rgba(var(--ink),0.3)', flexShrink: 0 }} />
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
        {launch.launchSite && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
            <MapPin size={10} style={{ color: 'rgba(var(--ink),0.3)', flexShrink: 0 }} />
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(var(--ink),0.4)', letterSpacing: '0.04em' }}>
              {launch.launchSite}
            </span>
          </div>
        )}
        ...
        {launch.probability != null && (
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(var(--ink),0.35)', letterSpacing: '0.06em' }}>
...
function EmptyState({ tab }: { tab: Tab }) {
  return (
    <div style={{
      ...
      <Rocket size={28} style={{ color: 'rgba(var(--ink),0.12)', marginBottom: '12px' }} />
      ...
      <p style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', color: 'rgba(var(--ink),0.2)', marginTop: '6px', marginBottom: 0 }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
        <div>
          ...
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'rgba(var(--ink),0.35)', letterSpacing: '0.1em', textTransform: 'uppercase', margin: '6px 0 0' }}>
            ...
            {lastFetched && (
              <span style={{ color: 'rgba(var(--ink),0.2)' }}>
      ...
      {data && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '12px' }}>
          {[
            ...
            { label: 'Recent',        value: data.recent.length,                                                        color: 'rgba(var(--ink),0.5)' },
            ...
            <div key={stat.label} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '8px', padding: '14px 16px' }}>
              ...
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(var(--ink),0.35)', marginTop: '5px' }}>
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <div style={{
        ...
        <p style={{ margin: 0, fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(var(--ink),0.35)', lineHeight: 1.6, letterSpacing: '0.04em' }}>
          ...
          <code style={{ fontSize: '9px', color: 'rgba(var(--ink),0.4)', background: 'rgba(var(--ink),0.05)', padding: '1px 5px', borderRadius: '3px' }}>/live/launches</code>.
        </p>
      </div>
