    ...
    <div style={{
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginTop: '4px', flexWrap: 'wrap' }}>
          {author.bio && (
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', color: 'rgba(var(--ink),0.82)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '320px' }}>
              {author.bio}
            </span>
          )}
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'rgba(var(--ink),0.78)', letterSpacing: '0.06em', flexShrink: 0 }}>
            <FileText size={9} />
            {author.articleCount} {author.articleCount === 1 ? 'article' : 'articles'}
          </span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'rgba(var(--ink),0.72)', letterSpacing: '0.04em', flexShrink: 0 }}>
    ...
    >
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 22px', borderBottom: '1px solid var(--border)' }}>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(var(--ink),0.82)' }}>
        ...
        <div style={{ padding: '22px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {([
                ...
                <div key={key} style={{ display: 'grid', gridTemplateColumns: '72px 1fr', gap: '8px', alignItems: 'center' }}>
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(var(--ink),0.78)' }}>
                    {label}
                  </span>
                  <input
                    value={form[key]}
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <p style={{ margin: '2px 0 0', fontFamily: 'var(--font-sans)', fontSize: '12px', color: 'rgba(var(--ink),0.78)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        {loading ? (
          ...
          <div style={{ padding: '48px 24px', background: 'var(--surface)', border: '1px dashed var(--border)', borderRadius: '10px', textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', color: 'rgba(var(--ink),0.72)', marginTop: '6px', marginBottom: '16px' }}>
      ...
      {deleteTarget && (
        ...
        >
          <div style={{ background: 'var(--black)', border: '1px solid rgba(231,76,60,0.3)', borderRadius: '12px', padding: '28px', maxWidth: '400px', width: '100%' }}>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', color: 'rgba(var(--ink),0.78)', lineHeight: 1.6, margin: '0 0 20px' }}>
