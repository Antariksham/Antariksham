...
function SolarSystemScale({ probes }: { probes: DeepSpaceProbe[] }) {
  ...
  // Min 4% ensures even Parker Solar Probe (0.046 AU) is visually distinct from the Sun dot
  const toPct   = (au: number) =>
    Math.max(4, Math.min(((Math.log10(Math.max(au, 0.04)) - LOG_MIN) / (LOG_MAX - LOG_MIN)) * 100, 96))

  // Sort probes closest → furthest for display order
  ...
  return (
    <div style={{
      ...
      {/* One row per probe — no overlap possible */}
          ...
          return (
            <div key={probe.id} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: '14px', flexShrink: 0 }}>{probeIcon(probe.id)}</span>
                <span style={{
                  fontFamily:    'var(--font-mono)',
                  fontSize:      '11px',
                  color:         color,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  width:        `${pct}%`,
                  height:       '3px',
                  background:   `linear-gradient(90deg, #f5c51840, ${color}90)`,
                  borderRadius: '2px',
                }} />

                {/* Probe dot at end of bar */}
                <div style={{
                  position:     'absolute',
                  left:         `${pct}%`,
                  width:        '12px',
              ...
              {/* Distance label — fixed width right */}
              <div style={{
                width:      '90px',
                flexShrink: 0,
                textAlign:  'right',
                ...
                <span style={{
                  ...
                  {formatAU(probe.distanceFromSun)}
                </span>
                <span style={{
                  fontFamily:  'var(--font-mono)',
                  fontSize:    '11px',
        ...
        {AU_TICKS.map(au => {
          ...
          return (
            <div key={au} style={{
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', color: 'rgba(240,244,250,0.35)', whiteSpace: 'nowrap' }}>
                {au} AU
              </span>
            </div>
          )
      ...
      <div style={{ marginLeft: '172px' }}>
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'rgba(240,244,250,0.28)', letterSpacing: '0.06em' }}>
          Logarithmic scale
        </span>
      </div>
    </div>
        ...
        <div style={{ padding: '24px 26px 26px' }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              <span suppressHydrationWarning>Launched {missionAge(probe.launchDate)} ago</span>
            </span>
            <span style={{
              fontFamily:    'var(--font-mono)',
              fontSize:      '12px',
