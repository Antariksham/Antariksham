                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <span style={{
                        ...
                        <span suppressHydrationWarning>Launched {new Date(currentProbe.launchDate).getFullYear()}</span>
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
              <div>
                ...
                <span style={{
                  ...
                  <span suppressHydrationWarning>Updated {new Date(lastUpdated).toLocaleString('en-US', {
            ...
            <div style={{
              ...
              <div style={{ padding: '20px', background: 'rgba(255,255,255,0.04)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: '16px', fontWeight: 600, color: '#ffffff', lineHeight: 1.4 }}>
                  <span suppressHydrationWarning>{missionAge(currentProbe.launchDate)}</span>
                </div>
              </div>
            </div>
